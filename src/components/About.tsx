          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8 max-w-5xl mx-auto">
            {certifications.map((cert, index) => (
              <Badge 
                ...
                className={`text-sm px-3 py-2 cursor-pointer transition-all duration-300 hover:scale-105 interactive-button animate-fade-in-up text-center justify-center flex items-center min-w-fit ${
