        ...
        >
          ...
          <Tabs defaultValue="simple-affordable" className="w-full max-w-none">
            <TabsList className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 w-full max-w-6xl mx-auto gap-2 sm:gap-3 mb-6 sm:mb-8 h-auto mobile-px p-2 sm:p-3">
              <TabsTrigger value="simple-affordable" className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm lg:text-sm px-3 sm:px-4 lg:px-4 py-3 sm:py-4 mobile-touch-target w-full justify-center min-h-[3rem] sm:min-h-[3.5rem] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=inactive]:bg-primary/10 data-[state=inactive]:text-foreground hover:bg-primary/20 transition-all duration-200">
                <DollarSign className="w-4 sm:w-5 lg:w-5 xl:w-6 h-4 sm:h-5 lg:h-5 xl:h-6 flex-shrink-0 data-[state=active]:text-aviation-gold data-[state=inactive]:text-primary/70" />
              ...
              <TabsTrigger value="quality-aircraft" className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm lg:text-sm px-3 sm:px-4 lg:px-4 py-3 sm:py-4 mobile-touch-target w-full justify-center min-h-[3rem] sm:min-h-[3.5rem] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=inactive]:bg-primary/10 data-[state=inactive]:text-foreground hover:bg-primary/20 transition-all duration-200">
                <Shield className="w-4 sm:w-5 lg:w-5 xl:w-6 h-4 sm:h-5 lg:h-5 xl:h-6 flex-shrink-0 data-[state=active]:text-aviation-gold data-[state=inactive]:text-primary/70" />
              ...
              <TabsTrigger value="quality-over-quantity" className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm lg:text-sm px-3 sm:px-4 lg:px-4 py-3 sm:py-4 mobile-touch-target w-full justify-center min-h-[3rem] sm:min-h-[3.5rem] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=inactive]:bg-primary/10 data-[state=inactive]:text-foreground hover:bg-primary/20 transition-all duration-200">
                <Heart className="w-4 sm:w-5 lg:w-5 xl:w-6 h-4 sm:h-5 lg:h-5 xl:h-6 flex-shrink-0 data-[state=active]:text-aviation-gold data-[state=inactive]:text-primary/70" />
              ...
              <TabsTrigger value="environmental" className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm lg:text-sm px-3 sm:px-4 lg:px-4 py-3 sm:py-4 mobile-touch-target w-full justify-center min-h-[3rem] sm:min-h-[3.5rem] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=inactive]:bg-primary/10 data-[state=inactive]:text-foreground hover:bg-primary/20 transition-all duration-200">
                <Leaf className="w-4 sm:w-5 lg:w-5 xl:w-6 h-4 sm:h-5 lg:h-5 xl:h-6 flex-shrink-0 data-[state=active]:text-aviation-gold data-[state=inactive]:text-primary/70" />
              ...
              <TabsTrigger value="instructors" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm lg:text-xs xl:text-sm px-2 sm:px-3 lg:px-3 py-3 sm:py-4 mobile-touch-target w-full justify-center min-h-[3rem] sm:min-h-[3.5rem] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=inactive]:bg-primary/10 data-[state=inactive]:text-foreground hover:bg-primary/20 transition-all duration-200">
                <Users className="w-4 sm:w-5 lg:w-4 xl:w-5 h-4 sm:h-5 lg:h-4 xl:h-5 flex-shrink-0 data-[state=active]:text-aviation-gold data-[state=inactive]:text-primary/70" />
